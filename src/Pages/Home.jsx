...
const WORDS = ["Aspiring Data Scientist", "Aspiring Data Analyst", "Data Enthusiast", "Data Explorer"];
const TECH_STACK = ["Analytics", "SQL", "Visualization", "Machine Learning"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/SaiGanesh1809" },
  { icon: Linkedin, link: "http://www.linkedin.com/in/ganeshgudibanda" },
  { icon: Instagram, link: "https://www.instagram.com/saiganesh__46" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Delivering innovative, insightful, and impactful data-driven solutions through analytics and machine learning.
                </p>
